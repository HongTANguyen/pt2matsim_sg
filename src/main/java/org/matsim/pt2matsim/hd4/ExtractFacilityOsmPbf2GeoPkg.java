...
public class ExtractFacilityOsmPbf2GeoPkg implements MATSimAppCommand {

	private static final Logger log = LogManager.getLogger(ExtractFacilityOsmPbf2GeoPkg.class);
	...
	@CommandLine.Mixin
	private final CrsOptions crs = new CrsOptions("EPSG:3414", Workflow_SG_HD4.getOutputCRS());
	...
	public static void main(String[] args) {
		new ExtractFacilityOsmPbf2GeoPkg().execute(args);
	}
	...
	private MultiPolygon createPolygon(OsmEntity entity) {
		...
		switch (geom) {
			case null -> throw new IllegalStateException("Unrecognized type.");
			case LinearRing lr -> {
